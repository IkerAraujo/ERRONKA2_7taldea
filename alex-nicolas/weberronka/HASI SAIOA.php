...
// KONEXIOA
// =====================
include_once "konexioa.php"; // trae $conexion
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Consulta preparada usando $conexion
    ...
    if ($result->num_rows === 1) {
        ...
        // PASAHITZA KONPROBATZEN DU
        if ($pasahitza === $user["pass"]) {
            // Guardar sesión
            $_SESSION["user_id"] = $user["id"];

            // ONDO BALDIN BADAGO SARRERA-RA BIDALTZEN DIZU
